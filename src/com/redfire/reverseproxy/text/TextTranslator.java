...
import static com.redfire.reverseproxy.model.RegexPair.*;

import java.util.List;

import com.google.common.collect.*;
import com.redfire.reverseproxy.model.*;
...
public class TextTranslator {
  ...
  private static final RegexPair ACTION= pair("<form\\b(\"[^\"]*\"|'[^']*'|[^'\">])*>",    // match <form .*> tags
          "\\baction\\b\\s*=\\s*(\\S*?)[\\s>]");            // match src attribute value


  private static final List<RegexPair> TAGS_PATTERNS= ImmutableList.of(ANCHOR, IMAGE, LINK, SCRIPT,ACTION);
