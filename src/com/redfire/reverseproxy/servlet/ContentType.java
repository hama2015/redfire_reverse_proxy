...
public class ContentType {
  ...
  public ContentType(Header header, String url) {
	System.out.println( "ContentType " + header.getValue());  
  ...
  private static boolean isText(String value) {
    if (containsIgnoreCase(value, "html")) return true; //xml html
    if (containsIgnoreCase(value, "javascript")) return true;
    if (containsIgnoreCase(value, "css")) return true;
    return false;
  }
