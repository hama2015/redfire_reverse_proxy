...
import com.redfire.reverseproxy.text.*;
...
public class ContentTranslator {
  ...
  public void translate(HttpEntity entity, HttpServletRequest httpLocalRequest, ServletResponse response) {
    if (entity==null) return;
    
    ContentType contentType= new ContentType(entity.getContentType(), newUrl);
    System.out.println(" ------contentType:"+contentType.value);
    ...
    text= SwpReplace.replaceRemoteText(text, httpLocalRequest);
